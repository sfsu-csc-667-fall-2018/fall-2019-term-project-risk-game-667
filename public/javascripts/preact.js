...
function g(l) {
  ;((!l.__d && (l.__d = !0) && 1 === u.push(l)) || t !== n.debounceRendering) &&
    ...
    (l.__k = b(l.__k, function (u) {
      if (null != u) {
        if (
          ((u.__ = l),
          (u.__b = l.__b + 1),
          null === (p = k[v]) || (p && u.key == p.key && u.type === p.type))
        )
          k[v] = void 0
        else
          for (h = 0; h < _; h++) {
        ...
        if (
          ...
          if ((null == w && (w = d), void 0 !== u.__d))
            ...
            n: if (null == c || c.parentNode !== n) n.appendChild(d), (e = null)
            else {
...
function T(n, l, u, i, t, o, r, c) {
  ...
  if (null === l.type) d !== y && n.data != y && (n.data = y)
    ...
    x(n, y, d, t, c),
      ...
      h || _(n, l, u, i, 'foreignObject' !== l.type && t, o, r, f, c),
      c ||
        ('value' in y &&
          void 0 !== y.value &&
          y.value !== n.value &&
...
function j(l, u, i) {
  ...
  if (
    ...
    (t = l.ref) && ((t.current && t.current !== l.__e) || $(t, null, u)),
