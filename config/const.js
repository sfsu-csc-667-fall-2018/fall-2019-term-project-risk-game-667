...
const INITIAL_ARMIES = [0, 0, 40, 35, 30, 25, 20]
...
const COUNTRY_CONNECTIONS = new Map([
  ...
  [
    'western-europe',
    ['great-britain', 'southern-europe', 'northern-europe', 'north-africa'],
  ],
  ...
  [
    'alberta',
    ['ontario', 'alaska', 'northwest-territory', 'western-united-states'],
  ],
  [
    'central-america',
  ...
  [
    'eastern-united-states',
    ['western-united-states', 'central-america', 'quebec', 'ontario'],
  ],
  ...
  [
    'western-united-states',
    ['eastern-united-states', 'ontario', 'alberta', 'central-america'],
  ],
