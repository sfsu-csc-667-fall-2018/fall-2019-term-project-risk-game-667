      ...
      (this.open = function (b) {
        ...
        ;(h.onopen = function () {
          ...
          (h.onmessage = function (b) {
            ;(g.debug || a.debugAll) &&
              console.debug('ReconnectingWebSocket', 'onmessage', g.url, b.data)
            var c = l('message')
